    ...
    <div class="flex flex-col p-4">
        ...
        <div class="flex items-center justify-between my-2">
            <div class=" flex justify-center items-center">
                ...
                <PhCircle 
                    :size="20" 
                    :color="getCanGetColor(welfare.canGet)" 
                    weight="fill" 
                    class="mx-5"
                />                
            </div>
            ...
            <div class="relative">
      <PhInfo :size="20" class=" cursor-pointer" @click="showTooltip = !showTooltip" />
      <div v-if="showTooltip" class="absolute right-0 bottom-8 w-44 bg-slate-50 space-y-2  text-sm p-2 rounded shadow-md">
