<template>
  <div class="flex justify-start pb-1 mb-2 ml-6">
    <div class="dropdown relative">
      ...
      <div v-if="showRegionDropdown" class="absolute top-full left-0 bg-white border border-gray-300 z-10 p-2 w-44">
    ...
    <div class="relative dropdown ml-2">
      ...
      <div v-if="showServiceDropdown" class="absolute top-full left-0 bg-white border border-gray-300 z-10 p-2 w-44">
